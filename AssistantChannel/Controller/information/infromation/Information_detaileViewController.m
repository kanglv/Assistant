//
//  Information_detaileViewController.m
//  AssistantChannel
//
...
@interface Information_detaileViewController ()
{
...
@implementation Information_detaileViewController
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        self.titleImg = [[UIImageView alloc]initWithFrame:CGRectMake(8, 5, SCREEN_WIDTH - 16, 105)];
        self.titleImg.image = [UIImage imageNamed:@"img_setting_image"];
...
- (void)getData{
    ...
    [service getNetWorkData:param Successed:^(id entity) {
        ...
        if ([strState isEqualToString:@"1"]) {
            ...
            [self.titleImg sd_setImageWithURL:[NSURL URLWithString:[BASEURL stringByAppendingString:entity.img]] placeholderImage:[UIImage imageNamed:@"img_setting_image"]];
