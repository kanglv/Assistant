...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        lableItem = [[UIBarButtonItem alloc] initWithTitle:@"请选择起始时间" style:UIBarButtonItemStylePlain target:nil action:nil];
        
        UIBarButtonItem *flexibleSpaceItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace
                                                                                           target:nil
                                                                                           action:nil];
        toolbar.items = @[cancelItem,flexibleSpaceItem,lableItem,flexibleSpaceItem,doneItem];
...
//        NSLocale *locale = [[NSLocale alloc] initWithLocaleIdentifier:@"zh_CN"];//设置为中文
        ...
        lableItem.title = [NSString stringWithFormat:@"%@ ~ %@",startDateStr,endDateStr];
    }
