...
- (id)initWithFrame:(CGRect)frame andPages:(NSArray *)pagesArray {
    ...
    if (self) {
        ...
        self.searchText.layer.cornerRadius = 4;
...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.searchBtn = [[UIButton alloc]initWithFrame:CGRectMake(VIEWWIDTH - 55, 40, 50, 30)];
        ...
        UILabel *line = [[UILabel alloc]initWithFrame:CGRectMake(VIEWWIDTH - 57, 40, 2, 30)];
